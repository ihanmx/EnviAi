      ...
      >
        ...
        {isMedium ? (
            ...
            >
              <List>
                ...
                <ListItem
                  ...
                  onClick={toggleDrawer(false)}
                >
                  <ListItemText primary="Pre-MadeDesigns" />
                </ListItem>
                <ListItem
                  button
                  component={Link}
          ...
          <>
            ...
            <Tabs
              ...
              sx={{
                ...
                "& .MuiTab-root.Mui-selected": {
                  color: isDarkMode ? "#b0bec5" : theme.palette.primary.main,
                },
                "& .MuiTabs-indicator": {
            ...
            <Box>
              <Stack direction="row" spacing={2}>
                <Link to="/WishlistPage" style={{ textDecoration: "none" }}>
